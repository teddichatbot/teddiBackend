const ChatDao = require("../models/chatDao");
 ...
 class ChatList {
   ...
   async chatHistory(req, res) {
    var sql = 'SELECT * FROM chatHistory ch WHERE ch.conversation.id = "'+req.body.conversationId+'" AND ch.chapterType = "'+req.body.chapterType+'" ORDER BY ch._ts DESC OFFSET '+req.body.offset+' LIMIT '+req.body.limit ;
